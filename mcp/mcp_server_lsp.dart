...
/// DART MCP SERVER: Language Server Protocol Integration
/// Provides LSP-based code quality checking and navigation
class LspMCPServer extends BaseMCPServer {
  final bool enableDebugLogging;
  final Duration executionTimeout;
  final String workingDirectory;

  LspMCPServer({
    super.name = 'lsp-server',
    super.version = '1.0.0',
    super.logger,
